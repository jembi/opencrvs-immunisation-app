...
tap.test('Events service', { autoend: true }, (t) => {
  ...
  tap.test('.constructSimpleHIVConfirmationObject()', { autoend: true }, (t) => {
    t.test('should construct a simple object for HIV confirmation', (t) => {
      ...
      // when
      const hivConfimObj = eventService.constructSimpleHIVConfirmationObject(encounter, [observation, observationPartner])
  ...
  tap.test('.constructSimpleFirstViralLoadObject()', { autoend: true }, (t) => {
    t.test('should construct a simple object for First Viral Load', (t) => {
      ...
      // when
      const highViralLoadObj = eventService.constructSimpleFirstViralLoadObject(encounter, [observation])
